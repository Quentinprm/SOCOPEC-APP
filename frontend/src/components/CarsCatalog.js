...
export default class CarsCatalog extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
  ...
  tabCars() {
    ...
    return this.state.cars.map(function(car, index) {
      return (
        <div className="car">
          <div className="carPict">
            <img
              src={
                car.Picture == ' '
                  ? 'https://www.automobile-magazine.fr/asset/cms/840x394/167662/config/116471/toyota-g1-hero-2-rgb.webp?webp=1'
                  : car.Picture
              }
            />
            <button onClick={that.handleShowResa}>Prêter</button>
          </div>

          <table className="carInfos">
            <thead>
              <tr>
                <th>{car.ModelName}</th>
              </tr>
            ...
            <tr>
              <td>Agence:Nancy</td>
              <td>Poids: {car.Weight}Kg</td>
              <td>Longueur: {car.Length}cm</td>
            </tr>
            <tr>
              <td>Année: {car.Year}</td>
              <td>Puissance: {car.Power}ch</td>
              <td>Largeur: {car.Width}cm</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>Hauteur: {car.Height}cm</td>
            </tr>
          </table>
  ...
  render() {
    return (
      <div>
        ...
        <div id="filters" style={{ opacity: !this.state.show ? '1' : '0.05' }}>
          <div id="filterAgencies">
            <h2>Agence</h2>
            <input type="text" placeholder="nom agence" />
          ...
          <div id="filterYear">
            ...
            <input
              type="text"
              value={this.state.filterYearA}
              onChange={this.handleChangeYearA}
              placeholder="Année min"
            />
            <input
              type="text"
              value={this.state.filterYearB}
              onChange={this.handleChangeYearB}
          ...
          <div id="filterPower">
            ...
            <input
              type="text"
              value={this.state.filtersPowerMax}
              onChange={this.handleChangePowerMax}
              placeholder="Puissance Max"
            />
            <hr></hr>
          </div>
          <div id="filterDimensions">
            <h2>Dimensions</h2>
            <input
              type="text"
              value={this.state.filtersLength}
        ...
        <div id="carslist" style={{ opacity: !this.state.show ? '1' : '0.05' }}>
          ...
          <div>
            {this.state.cars.length} véhicules trouvés{' '}
